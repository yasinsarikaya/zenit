...
// Kennung dieses GerÃ¤ts/Tabs â€” verhindert Echo beim Live-Sync
...
const T = {
  de: {
    ...
    addTask: "Neue Aufgabe", taskTitle: "Was mÃ¶chtest du erreichen?",
    descPh: "Beschreibung (optional)â€¦", chooseLevel: "Zeitebene",
    ...
    repeatInfo: "Nach Abschluss: Wiederholung nach 1, 3 und 7 Wochen â€” danach 2Ã— pro Monat.",
    save: "Fertig", cancel: "Abbrechen", next: "Weiter", back: "ZurÃ¼ck",
    adoptWeek: "NÃ¤chste Woche", adoptAsk: "FÃ¼r nÃ¤chste Woche einplanen?",
    planSunday: "Sonntag â€” Wochenplanung", planMonth: "Letztes Wochenende â€” Monatsplanung",
    fixedTag: "fest",
    overdue: "ÃœberfÃ¤llig", openTasks: "Offen", doneWeek: "Diese Woche",
    focusHead: "Im Fokus",
    motivation: "Motivations-SÃ¤tze", addSentence: "Neuen Satz schreibenâ€¦", add: "HinzufÃ¼gen",
    ...
    emptyMotiv: "Schreibe deinen ersten Satz in den Einstellungen â—‡",
    emptyDue: "Alles ruhig. Nichts fÃ¤llig.",
    emptyHist: "Noch keine erledigten Aufgaben.",
    rep: "Wiederholung", repOf: "von 3", repMonthly: "2Ã— pro Monat",
    lesson: "Lektion", dueOn: "fÃ¤llig",
    planDays: "Fixe Planungstage",
    planDaysInfo: "Jeden Sonntag: Wochenplanung. Letzter Samstag + Sonntag im Monat: Monatsplanung. UnverÃ¤nderbar.",
    ringDone: "erledigt heute",
    jewel: "Dein Juwel", level: "Stufe", xpTo: "XP bis zur nÃ¤chsten Stufe",
    tiers: ["Rohstein", "Geschliffen", "Facettiert", "Brillant", "Zenit"],
    remindT: "Erinnerung", remindOver: "Ã¼berfÃ¤llig", remindWait: "in der Warteliste", show: "Ansehen",
    reviewWeek: "Wochen-RÃ¼ckblick", reviewMonth: "Monats-RÃ¼ckblick",
    reviewInfoW: "Diese Wochenaufgaben sind noch offen â€” entscheide, was mit ihnen passiert:",
    reviewInfoM: "Diese Monatsaufgaben sind noch offen â€” entscheide, was mit ihnen passiert:",
    nextMonth: "NÃ¤chster Monat", later: "SpÃ¤ter", reviewEmpty: "Alles entschieden â—‡",
    coach: "Zenit-Coach", coachBtn: "Woche mit dem Coach planen",
    coachSun: "Es ist Sonntag â€” lass uns deine Woche planen â—‡",
    coachThink: "Der Coach betrachtet dein Juwelâ€¦",
    coachErr: "Coach gerade nicht erreichbar â€” versuch es gleich nochmal.",
    coachSetup: "Coach-Funktion noch nicht eingerichtet â€” siehe README, Schritt 7.",
    coachAdd: "Ãœbernehmen", coachAgain: "Neu planen",
    coachHint: "Der Coach kennt deine offenen Aufgaben, deine Warteliste und deine Woche â€” und schlÃ¤gt dir einen Plan vor.",
    ...
    bestDay: "StÃ¤rkster Wochentag", history: "Alles Geschaffte", todayW: "Heute",
    account: "Konto", signOut: "Abmelden",
    authTitle: "Willkommen bei Zenit",
    authInfo: "Melde dich mit deiner E-Mail an â€” du bekommst einen Login-Link. Damit synchronisiert sich Zenit zwischen Handy und Website.",
    authEmail: "deine@email.de", authSend: "Login-Link senden",
    authSent: "Link verschickt! PrÃ¼fe dein Postfach â—‡",
    authErr: "Das hat nicht geklappt â€” prÃ¼fe die E-Mail-Adresse.",
    notif: "Benachrichtigungen", notifEnable: "Aktivieren", notifOn: "Aktiv â—‡",
    notifDenied: "Im Browser blockiert â€” erlaube Benachrichtigungen in den Seiteneinstellungen.",
    notifUnsupported: "Dieser Browser unterstÃ¼tzt keine Benachrichtigungen.",
    notifTime: "TÃ¤gliche Erinnerung um",
    notifInfo: "TÃ¤gliche Zusammenfassung (FÃ¤lliges, Warteliste, Planungstage), solange Zenit installiert bzw. geÃ¶ffnet ist. Push bei komplett geschlossener App = Stufe 2 (README).",
    nDue: "heute fÃ¤llig", nOver: "Ã¼berfÃ¤llig", nWait: "in der Warteliste",
    nSun: "Wochenplanung heute", nMon: "Monatsplanung dieses Wochenende",
  },
  tr: {
    tagline: "GÃ¼nÃ¼n zirvesi",
    greetM: "GÃ¼naydÄ±n", greetA: "Ä°yi gÃ¼nler", greetE: "Ä°yi akÅŸamlar",
    navDash: "Zenit", navTasks: "GÃ¶revler", navAna: "Analiz", navWait: "Bekleme",
    day: "GÃ¼n", week: "Hafta", month: "Ay", long: "Uzun Vade",
    addTask: "Yeni gÃ¶rev", taskTitle: "Neyi baÅŸarmak istiyorsun?",
    descPh: "AÃ§Ä±klama (isteÄŸe baÄŸlÄ±)â€¦", chooseLevel: "Zaman dÃ¼zeyi",
    category: "Kategori", newCategory: "Yeni kategori", noCategory: "Yok",
    isLesson: "Bu bir ders mi?", yes: "Evet", no: "HayÄ±r",
    repeatQ: "Tekrar planÄ± etkinleÅŸtirilsin mi?",
    repeatInfo: "TamamlandÄ±ktan sonra: 1, 3 ve 7 hafta sonra tekrar â€” ardÄ±ndan ayda 2 kez.",
    save: "Tamam", cancel: "Ä°ptal", next: "Ä°leri", back: "Geri",
    adoptWeek: "Gelecek hafta", adoptAsk: "Gelecek hafta iÃ§in planlansÄ±n mÄ±?",
    planSunday: "Pazar â€” haftalÄ±k planlama", planMonth: "Son hafta sonu â€” aylÄ±k planlama",
    fixedTag: "sabit",
    overdue: "GecikmiÅŸ", openTasks: "AÃ§Ä±k", doneWeek: "Bu hafta",
    focusHead: "Odakta",
    motivation: "Motivasyon cÃ¼mleleri", addSentence: "Yeni cÃ¼mle yazâ€¦", add: "Ekle",
    settings: "Ayarlar", categories: "Kategoriler", gem: "TaÅŸÄ±nÄ± seÃ§",
    gemNames: { emerald: "ZÃ¼mrÃ¼t", sapphire: "Safir", amethyst: "Ametist", champagne: "AltÄ±n" },
    emptyTasks: "Bu dÃ¼zeyde aÃ§Ä±k gÃ¶rev yok.",
    emptyWait: "Bekleme listesi boÅŸ.",
    emptyMotiv: "Ä°lk cÃ¼mleni ayarlardan yaz â—‡",
    emptyDue: "Her ÅŸey sakin. BugÃ¼n iÃ§in bir ÅŸey yok.",
    emptyHist: "HenÃ¼z tamamlanan gÃ¶rev yok.",
    rep: "Tekrar", repOf: "/ 3", repMonthly: "Ayda 2 kez",
    lesson: "Ders", dueOn: "tarih",
    planDays: "Sabit planlama gÃ¼nleri",
    planDaysInfo: "Her Pazar: haftalÄ±k plan. AyÄ±n son Cumartesi + Pazar gÃ¼nÃ¼: aylÄ±k plan. DeÄŸiÅŸtirilemez.",
    ringDone: "bugÃ¼n tamamlandÄ±",
    jewel: "TaÅŸÄ±n", level: "Seviye", xpTo: "sonraki seviyeye XP",
    tiers: ["Ham TaÅŸ", "Ä°ÅŸlenmiÅŸ", "Fasetli", "PÄ±rlanta", "Zenit"],
    remindT: "HatÄ±rlatma", remindOver: "gecikmiÅŸ", remindWait: "bekleme listesinde", show: "GÃ¶ster",
    reviewWeek: "Hafta deÄŸerlendirmesi", reviewMonth: "Ay deÄŸerlendirmesi",
    reviewInfoW: "Bu hafta gÃ¶revleri hÃ¢lÃ¢ aÃ§Ä±k â€” ne olacaÄŸÄ±na karar ver:",
    reviewInfoM: "Bu ay gÃ¶revleri hÃ¢lÃ¢ aÃ§Ä±k â€” ne olacaÄŸÄ±na karar ver:",
    nextMonth: "Gelecek ay", later: "Sonra", reviewEmpty: "Hepsi tamam â—‡",
    coach: "Zenit KoÃ§u", coachBtn: "HaftayÄ± koÃ§la planla",
    coachSun: "BugÃ¼n Pazar â€” haftanÄ± birlikte planlayalÄ±m â—‡",
    coachThink: "KoÃ§ taÅŸÄ±nÄ± inceliyorâ€¦",
    coachErr: "KoÃ§a ÅŸu an ulaÅŸÄ±lamÄ±yor â€” birazdan tekrar dene.",
    coachSetup: "KoÃ§ fonksiyonu henÃ¼z kurulmadÄ± â€” README, adÄ±m 7.",
    coachAdd: "Ekle", coachAgain: "Yeniden planla",
    coachHint: "KoÃ§ aÃ§Ä±k gÃ¶revlerini, bekleme listeni ve haftanÄ± bilir â€” sana bir plan Ã¶nerir.",
    anaHead: "Analizin",
    statsTotal: "Toplam tamamlanan", streak: "GÃ¼n serisi", lessonsDone: "Dersler",
    last7: "Son 7 gÃ¼n", byLevel: "DÃ¼zeye gÃ¶re", byCat: "Kategoriye gÃ¶re",
    bestDay: "En gÃ¼Ã§lÃ¼ gÃ¼n", history: "TÃ¼m baÅŸarÄ±lar", todayW: "BugÃ¼n",
    account: "Hesap", signOut: "Ã‡Ä±kÄ±ÅŸ yap",
    authTitle: "Zenit'e hoÅŸ geldin",
    authInfo: "E-postanla giriÅŸ yap â€” sana bir giriÅŸ baÄŸlantÄ±sÄ± gÃ¶ndereceÄŸiz. BÃ¶ylece Zenit telefon ve web arasÄ±nda senkronize olur.",
    authEmail: "eposta@adresin.com", authSend: "GiriÅŸ baÄŸlantÄ±sÄ± gÃ¶nder",
    authSent: "BaÄŸlantÄ± gÃ¶nderildi! Gelen kutunu kontrol et â—‡",
    authErr: "OlmadÄ± â€” e-posta adresini kontrol et.",
    notif: "Bildirimler", notifEnable: "EtkinleÅŸtir", notifOn: "Aktif â—‡",
    notifDenied: "TarayÄ±cÄ±da engellendi â€” site ayarlarÄ±ndan bildirimlere izin ver.",
    notifUnsupported: "Bu tarayÄ±cÄ± bildirimleri desteklemiyor.",
    notifTime: "GÃ¼nlÃ¼k hatÄ±rlatma saati",
    notifInfo: "Zenit yÃ¼klÃ¼/aÃ§Ä±kken gÃ¼nlÃ¼k Ã¶zet alÄ±rsÄ±n (bugÃ¼n olanlar, bekleme listesi, planlama gÃ¼nleri). Uygulama tamamen kapalÄ±yken push = 2. aÅŸama (README).",
    nDue: "bugÃ¼n", nOver: "gecikmiÅŸ", nWait: "bekleme listesinde",
    nSun: "bugÃ¼n haftalÄ±k planlama", nMon: "bu hafta sonu aylÄ±k planlama",
  },
  en: {
    ...
    descPh: "Description (optional)â€¦", chooseLevel: "Time level",
    ...
    repeatInfo: "After completion: repeat after 1, 3 and 7 weeks â€” then 2Ã— per month.",
    save: "Done", cancel: "Cancel", next: "Next", back: "Back",
    adoptWeek: "Next week", adoptAsk: "Plan for next week?",
    planSunday: "Sunday â€” weekly planning", planMonth: "Last weekend â€” monthly planning",
    fixedTag: "fixed",
    overdue: "Overdue", openTasks: "Open", doneWeek: "This week",
    focusHead: "In focus",
    motivation: "Motivation sentences", addSentence: "Write a new sentenceâ€¦", add: "Add",
    ...
    emptyMotiv: "Write your first sentence in settings â—‡",
    emptyDue: "All calm. Nothing due.",
    emptyHist: "No completed tasks yet.",
    rep: "Repetition", repOf: "of 3", repMonthly: "2Ã— per month",
    ...
    reviewInfoW: "These week tasks are still open â€” decide what happens to them:",
    reviewInfoM: "These month tasks are still open â€” decide what happens to them:",
    nextMonth: "Next month", later: "Later", reviewEmpty: "All decided â—‡",
    coach: "Zenit Coach", coachBtn: "Plan the week with the coach",
    coachSun: "It's Sunday â€” let's plan your week â—‡",
    coachThink: "The coach is studying your jewelâ€¦",
    coachErr: "Coach unavailable right now â€” try again shortly.",
    coachSetup: "Coach function not set up yet â€” see README, step 7.",
    coachAdd: "Add", coachAgain: "Plan again",
    coachHint: "The coach knows your open tasks, waitlist and week â€” and suggests a plan.",
    ...
    authInfo: "Sign in with your email â€” we'll send you a login link. Zenit then syncs between phone and web.",
    authEmail: "you@email.com", authSend: "Send login link",
    authSent: "Link sent! Check your inbox â—‡",
    authErr: "That didn't work â€” check the email address.",
    notif: "Notifications", notifEnable: "Enable", notifOn: "Active â—‡",
    notifDenied: "Blocked in the browser â€” allow notifications in site settings.",
...
export default function App() {
  ...
  if (!authChecked)
    return (<div className="z-root" style={{ "--acc": GEMS.emerald.acc, "--accSoft": GEMS.emerald.soft, "--accGlow": GEMS.emerald.glow }}>
      <style>{CSS}</style><div className="z-loading">â—‡</div></div>);
  ...
  if (!SUPABASE_CONFIGURED) return <Zenit session={null} />; if (!session) return <AuthScreen />;
...
function Zenit({ session }) {
  ...
  // ---- Sonntags- / Monatsende-RÃ¼ckblick ----
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const check = () => {
      ...
      if (parts.length) notify("Zenit â—‡", parts.join(" Â· "));
      setLastNotif(today());
    };
    check();
  ...
  if (!loaded)
    return (<div className="z-root" style={vars}><style>{CSS}</style><div className="z-loading">â—‡</div></div>);

  return (
    <div className="z-root" style={vars}>
      <style>{CSS}</style>
      <div className="z-halo" />
      {gain && <div className="z-xptoast">ï¼‹{gain} â—‡</div>}
          ...
          <>
            ...
            {!remindDismissed && (overdue.length > 0 || wait.length > 0) && (
              <div className="z-remind">
                <span className="z-remindtxt">
                  â—‡ {overdue.length > 0 && <b>{overdue.length} {t.remindOver}</b>}
                  {overdue.length > 0 && wait.length > 0 && " Â· "}
                ...
                <span className="z-remindacts">
                  ...
                  <button className="z-act dim" onClick={() => setRemindDismissed(true)}>âœ•</button>
                </span>
              </div>
            )}
            ...
            {(isSunday() || isLastWeekendOfMonth()) && (
              <div className="z-planline">
                {isSunday() && <span>â—‡ {t.planSunday} Â· <em>{t.fixedTag}</em></span>}
                {isLastWeekendOfMonth() && <span>â—‡ {t.planMonth} Â· <em>{t.fixedTag}</em></span>}
              </div>
            )}

            <button className={"z-coachcard" + (isSunday() ? " sun" : "")} onClick={() => setShowCoach(true)}>
              <span className="z-coachic">âœ¦</span>
              <span className="z-coachlbl">{isSunday() ? t.coachSun : t.coachBtn}</span>
              <span className="z-coacharrow">â†’</span>
            </button>
            ...
            <div className="z-jewelrow">
              ...
              <div className="z-jewelinfo">
                <div className="z-jeweltier">{t.tiers[tier - 1]}<span className="z-jewellvl"> Â· {t.level} {lvl}</span></div>
            ...
            {[...overdue, ...dueToday].map((task) => (
              <Card key={task.id} task={task} t={t} lang={lang} catColor={catColor}
                actions={<>
                  <button className="z-act main" onClick={() => completeTask(task)}>âœ“</button>
                  <button className="z-act" onClick={() => toWaitlist(task)}>â€–</button>
                </>} />
            ))}
          </>
        )}
          ...
          <>
            ...
            <List tasks={open.filter((x) => x.level === levelTab)} t={t} lang={lang} catColor={catColor} empty={t.emptyTasks}
              actions={(task) => <>
                <button className="z-act main" onClick={() => completeTask(task)}>âœ“</button>
                <button className="z-act" onClick={() => toWaitlist(task)}>â€–</button>
                <button className="z-act dim" onClick={() => delTask(task)}>âœ•</button>
              </>} />
          </>
        )}
        ...
        {view === "wait" && (
          <>
            ...
            <List tasks={wait} t={t} lang={lang} catColor={catColor} empty={t.emptyWait}
              actions={(task) => <>
                <button className="z-act main wide" onClick={() => adoptNextWeek(task)}>â†’ {t.adoptWeek}</button>
                <button className="z-act dim" onClick={() => delTask(task)}>âœ•</button>
              </>} />
          </>
        )}
      ...
      <nav className="z-dock">
        ...
        <button className="z-fab" onClick={() => setShowAdd(true)}>ï¼‹</button>
      </nav>
  ...
  return (
    <div className="z-ringwrap">
      ...
      <div className="z-ringcenter">
        <b>{done}<span className="z-ringof">/{total || "â€“"}</span></b>
...
function Analysis({ t, lang, done, catColor, totalXp }) {
  ...
  const catCount = {};
  done.forEach((x) => { const k = x.category || "â€“"; catCount[k] = (catCount[k] || 0) + 1; });
    ...
    <>
      ...
      {groups.map((grp) => (
        <div key={grp.d} className="z-histgroup">
          <div className="z-histdate">{grp.d === today() ? t.todayW : fmtFull(grp.d, lang)} <i>Â· {grp.items.length}</i></div>
          {grp.items.map((x) => (
            <div key={x.id} className="z-histitem">
              ...
              <span className="z-histmeta">{t[x.level]}{x.isLesson ? " Â· â—‡" : ""} Â· +{taskXp(x)}</span>
            </div>
          ))}
        </div>
      ))}
    ...
    <div className="z-card">
      ...
      <div className="z-cardbody" onClick={() => task.desc && setExpand((e) => !e)}>
        ...
        <div className="z-cardmeta">
          {task.category && <span style={{ color: catColor(task.category) }}>{task.category} Â· </span>}
          <span>{t[task.level]}</span>
          {task.isLesson && <span> Â· â—‡ {t.lesson}{task.repeat ? ` Â· ${repLabel(task.repStage || 0, t)}` : ""}</span>}
          {task.dueDate && <span className={late ? " z-red" : ""}> Â· {t.dueOn} {fmt(task.dueDate, lang)}</span>}
        </div>
      </div>
...
function CoachModal({ t, lang, open, wait, doneThisWeek, cats, onAdd, onClose }) {
  ...
  const langName = lang === "de" ? "Deutsch" : lang === "tr" ? "TÃ¼rkÃ§e" : "English";
  ...
  return (
    <div className="z-overlay" onClick={onClose}>
      <div className="z-sheet" onClick={(e) => e.stopPropagation()}>
        <div className="z-sheethead">âœ¦ {t.coach}</div>

        {state === "idle" && (<>
          <p className="z-info">{t.coachHint}</p>
          <button className="z-mainbtn" style={{ width: "100%", marginTop: 10 }} onClick={plan}>âœ¦ {t.coachBtn}</button>
        </>)}

        {state === "loading" && <div className="z-coachload">â—‡<br /><span>{t.coachThink}</span></div>}
        ...
        {state === "ready" && data && (<>
          ...
          <div className="z-sheetfoot">
            <button className="z-ghostbtn" onClick={plan}>â†» {t.coachAgain}</button>
...
function ReviewModal({ mode, t, tasks, catColor, onDone, onWait, onPush, onClose }) {
  ...
  return (
    <div className="z-overlay" onClick={onClose}>
      <div className="z-sheet" onClick={(e) => e.stopPropagation()}>
        <div className="z-sheethead">â—‡ {title}</div>
        ...
        {tasks.map((task) => (
          <div key={task.id} className="z-sug" style={{ flexWrap: "wrap" }}>
            ...
            <div className="z-cardacts" style={{ flexWrap: "wrap" }}>
              <button className="z-act main" onClick={() => onDone(task)}>âœ“</button>
              <button className="z-act wide" onClick={() => onPush(task)}>â†’ {pushLabel}</button>
              <button className="z-act" onClick={() => onWait(task)}>â€–</button>
            </div>
          </div>
        ))}
        <div className="z-sheetfoot">
      ...
      <div className="z-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        {step === 1 && (<>
          ...
          <div className="z-row">
            ...
            <button className="z-act main" onClick={() => { const c = onAddCat(newCat); if (c) { setCategory(c.name); setNewCat(""); } }}>ï¼‹</button>
          </div>
          <div className="z-sheetfoot">
        ...
        {step === 2 && (<>
          ...
          <div className="z-choice">
            <button className="z-choicebtn" onClick={() => { setIsLesson(true); setStep(3); }}>â—‡ {t.yes}</button>
            <button className="z-choicebtn" onClick={() => { setIsLesson(false); finish(false); }}>{t.no}</button>
          </div>
          <div className="z-sheetfoot"><button className="z-ghostbtn" onClick={() => setStep(1)}>â† {t.back}</button></div>
        </>)}
        ...
        {step === 3 && (<>
          ...
          <div className="z-choice">
            <button className="z-choicebtn" onClick={() => finish(true)}>â†» {t.yes}</button>
            <button className="z-choicebtn" onClick={() => finish(false)}>{t.no}</button>
          </div>
          <div className="z-sheetfoot"><button className="z-ghostbtn" onClick={() => setStep(2)}>â† {t.back}</button></div>
        </>)}
      </div>
    </div>
  );
      ...
      <div className="z-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        {sentences.map((s, i) => (
          <div key={i} className="z-sent">
            <span>{s}</span>
            <button className="z-act dim" onClick={() => setSentences(sentences.filter((_, j) => j !== i))}>âœ•</button>
          </div>
        ))}
        <div className="z-row">
          <input className="z-input slim" placeholder={t.addSentence} value={txt} onChange={(e) => setTxt(e.target.value)} />
          <button className="z-act main" onClick={() => { if (txt.trim()) { setSentences([...sentences, txt.trim()]); setTxt(""); } }}>ï¼‹</button>
        </div>
        ...
        <div className="z-pills">
          {cats.map((c) => (
            <span key={c.name} className="z-pill on">
              <span className="z-cdot" style={{ background: c.color }} />{c.name}
              <button className="z-xin" onClick={() => onDelCat(c.name)}>âœ•</button>
            </span>
          ))}
        </div>
        <div className="z-row">
          <input className="z-input slim" placeholder={t.newCategory} value={catTxt} onChange={(e) => setCatTxt(e.target.value)} />
          <button className="z-act main" onClick={() => { if (onAddCat(catTxt)) setCatTxt(""); }}>ï¼‹</button>
        </div>
